...
| Santé | Oui | 37 562 établissements | Points | `/api/health/*` | health_service | Stats, nearest | NEAR_HEALTH (NCI) | Decision Center panel | 🔴* |
...
\* Santé : référentiel peuplé, mais NSME n’interroge pas `health.health_facilities` (dérivation NCI) → **anomalie CAS 4**.
