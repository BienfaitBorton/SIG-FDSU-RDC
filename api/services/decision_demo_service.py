    ...
    return {
        ...
        "intents": [
            ...
            },
            {
                ...
                "data_used": ["strategie_fdsu_ccn_2026_2030.docx", "ccn_model.json"],
                "primary_action": "Analyser",
                "target_tab": "vue-nationale",
                "scenario_id": "follow_projects",
                "limitations": NOT_CALCULATED,
            ...
            },
            {
                ...
                "explanation": "Synthétiser KPI, priorités et limites de données pour un comité de pilotage.",
                "data_used": ["national-panel", "explain-kpi", "demo-scenarios"],
                "primary_action": "Exporter",
                "target_tab": "rapports",
                "scenario_id": "invest_priority",
            },
            {
