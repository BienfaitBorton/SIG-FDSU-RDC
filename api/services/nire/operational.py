...
class NireRepository(Protocol):
    ...
    def list_runs(self,*,status:str|None,source_name:str|None,offset:int,limit:int)->tuple[dict[str,Any],...]: ...
    def get_dossier(self,candidate_id:str)->dict[str,Any]|None: ...
    def get_history(self,candidate_id:str)->tuple[dict[str,Any],...]: ...
