...
LAYER_CATALOG: list[dict[str, Any]] = [
    {
        ...
        "fillColor": "#fb7185",
        "legend_group": "mno",
        "note": "Référentiel consolidé FDSU (DB + ajouts MNO) — total attendu 4133",
    },
    {
        ...
        "fillColor": "#fb923c",
        "legend_group": "mno",
        "note": "Référentiel consolidé FDSU (DB + ajouts MNO) — total attendu 4912",
    },
    {
    ...
    },
    {
        ...
        "asset_filter": "FIBER",
        "geometry_kinds": ["point", "line"],
        "default_on": False,
        "quality_mode": "REFERENTIAL",
        "color": "#2563eb",
        "fillColor": "#60a5fa",
        "legend_group": "backbone",
        "note": "Nœuds + lignes fibre — polygones de couverture exclus",
    },
    {
        ...
        "fillColor": "#a78bfa",
        "legend_group": "backbone",
        "note": "Liaisons MW — polygones exclus",
    },
    {
